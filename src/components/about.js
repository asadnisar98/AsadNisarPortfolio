            ...
            <section className="about maxwidth">
                <div id="about" className="about__main">
                    ...
                    <div className="text">
                        ...
                        >
                            <p>Experienced Frontend Developer with a strong background in HTML, SASS, CSS, jQuery, and JavaScript, including libraries and frameworks like ReactJS and Redux. Skilled in developing custom Front End solutions and integrating them with the latest technologies. Passionate about creating responsive and mobile-friendly designs, implementing best practices, and delivering high-quality projects. Currently seeking opportunities to contribute my expertise in frontend development to a dynamic team.
                            </p>
